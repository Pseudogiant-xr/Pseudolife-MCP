...
payloads are agent context on every retrieval; each entry keeps its write
`date`); pass `verbose=true` for full metadata. Full-table dumps and topology views live in the **Cortex Console**
