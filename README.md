...
its metadata refresh needs every session closed; on Windows a shim that
sessions are running is skipped, with the sessions counted and the rerun
named, because pip or pipx would leave it half-removed), refreshes the plugin
