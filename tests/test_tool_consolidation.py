...
def test_descriptions_fit_tier_budgets(tmp_path: Path, monkeypatch) -> None:
    ...
    # 2026-09-24: memory_message now tells agents an operator audit log
    # keeps a copy of each body (schema v42), paid for by trimming its own
    # reply_to / receive / ack wording: full 17,243, core 10,935.
